...
def build_prompt(user_prompt: str) -> str:
    ...
    if "cooper" in user_prompt_lower or "cooper sigrist" in user_prompt_lower:
        return f"{base}, realistic colored portrait from shoulders up {user_prompt}, a young white man with short brown hair, short stubby beard, average build, wearing a cap"
    else:
